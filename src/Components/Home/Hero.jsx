...
function Hero({ setToggleContact }) {
  return (
    <section
      ...
      id='home'
    >
      <div className=' h-full flex flex-row justify-center items-center pl-8 pr-8 '>
        <div className='md:w-7/12'>
          <div className='w-96 flex flex-col items-start gap-6 text-center md:text-left lg:gap-12 -translate-y-20'>
            ...
            <h2 className='text-base lg:text-lg'>
              ...
              value and ensures the safety and protection of homes and
              businesses.
            </h2>
