  ...
  return (
    ...
    >
      <form
        ...
        className=' flex flex-col gap-8 w-min bg-white text-dark-blue py-8 px-16 rounded-md relative'
      >
        <div
        ...
        <div className='column-flex'>
          ...
          <input type='text' className='custom-input' id='full-name' />
        </div>
        <div className='column-flex'>
        ...
        <div className='column-flex'>
          ...
          <textarea id='message' className='bg-grey p-3 rounded-sm' />
        </div>
